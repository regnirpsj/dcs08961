...
namespace scene {
  ...
  namespace object {
    ...
    namespace camera {
      ...
      {
        TRACE("scene::object::camera::base::compute_frustum");
      ...
      {
        TRACE("scene::object::camera::base::cb_get_projection");
      ...
      {
        TRACE("scene::object::camera::base::cb_set_projection");
      ...
      {
        TRACE("scene::object::camera::base::cb_get_frustum");
      ...
      {
        TRACE("scene::object::camera::base::cb_set_frustum");
