...
/**************************************************************************************************/
/*                                                                                                */
/*  module     :  scene/object/material.cpp                                                       */
/*  project    :                                                                                  */
/*  description:                                                                                  */
/*                                                                                                */
/**************************************************************************************************/
...
namespace scene {
  ...
  namespace object {
    ...
    {
      TRACE("scene::object::material::rep::rep");
    }
    ...
    {
      TRACE("scene::object::material::operator material::rep const&");
    ...
    {
      TRACE("scene::object::material::cb_get_ambient");
    ...
    {
      TRACE("scene::object::material::cb_set_ambient");
    ...
    {
      TRACE("scene::object::material::cb_get_diffuse");
    ...
    {
      TRACE("scene::object::material::cb_set_diffuse");
    ...
    {
      TRACE("scene::object::material::cb_get_emission");
    ...
    {
      TRACE("scene::object::material::cb_set_emission");
    ...
    {
      TRACE("scene::object::material::cb_get_specular");
    ...
    {
      TRACE("scene::object::material::cb_set_specular");
    ...
    {
      TRACE("scene::object::material::cb_get_transmission");
    ...
    {
      TRACE("scene::object::material::cb_set_transmission");
    ...
    {
      TRACE("scene::object::operator==(material::rep, material::rep)");
    ...
    {
      TRACE_NEVER("scene::object::operator<<(material::rep)");
