...
/**************************************************************************************************/
/*                                                                                                */
/*  module     :  scene/loader/obj.cpp                                                            */
/*  project    :                                                                                  */
/*  description:                                                                                  */
/*                                                                                                */
/**************************************************************************************************/

// $Id: obj.cpp 656 2014-02-28 10:56:35Z regnirpsj $
...
namespace {
  ...
  struct face_parser : qi::grammar<IT, glm::ivec3(), ascii::space_type> {
    ...
    {
      TRACE_NEVER("scene::file::obj::<unnamed>::face_parser::face_parser");
  ...
  struct normal_parser : qi::grammar<IT, glm::vec3(), ascii::space_type> {
    ...
    {
      TRACE_NEVER("scene::file::obj::<unnamed>::normal_parser::normal_parser");
  ...
  struct tcoord_parser : qi::grammar<IT, glm::vec3(), ascii::space_type> {
    ...
    {
      TRACE_NEVER("scene::file::obj::<unnamed>::tcoord_parser::tcoord_parser");
  ...
  struct vertex_parser : qi::grammar<IT, glm::vec4(), ascii::space_type> {
    ...
    {
      TRACE_NEVER("scene::file::obj::<unnamed>::vertex_parser::vertex_parser");
  ...
  {
    TRACE_NEVER("scene::file::obj::<unnamed>::parse<" +
    ...
    if (result && first == last) {
      std::cout << support::trace::prefix() << "scene::file::obj::parse<"
                << support::demangle(typeid(P)) << ',' << support::demangle(typeid(O)) << ">: "
...
namespace scene {
  ...
  namespace file {
    ...
    namespace obj {
      ...
      load(std::istream& is, path_list_type const& path_list)
      {
        ...
        while (std::getline(is, line)) {
          ...
          if      ("f" == *tokens.begin()) { // f v/[t]/[n]
            ...
            std::cout << support::trace::prefix() << "scene::file::obj::load(std::istream): "
      ...
      {
        TRACE("scene::file::obj::save(std::ostream)");
      ...
      {
        TRACE("scene::file::obj::save(std::string) [" + a + "]");
