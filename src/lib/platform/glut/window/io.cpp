...
/**************************************************************************************************/
/*                                                                                                */
/*  module     :  platform/glut/winow/io.cpp                                                      */
/*  project    :                                                                                  */
/*  description:                                                                                  */
/*                                                                                                */
/**************************************************************************************************/
...
namespace platform {
  ...
  namespace glut {
    ...
    namespace window {
      ...
      std::ostream& operator<<(std::ostream& os, platform::window::frame_record_t const& a)
      {
      ...
      std::ostream& operator<<(std::ostream& os, platform::window::keyboard_record_t const& a)
      {
        TRACE_NEVER("platform::glut::operator<<(keyboard_record_t)");
      ...
      std::ostream& operator<<(std::ostream& os, platform::window::mouse_record_t const& a)
      {
