...
IF(CMAKE_COMPILER_IS_GNUCC)
  MESSAGE(STATUS "Applying Compiler Defaults for: GCC (v. ${CMAKE_CXX_COMPILER_VERSION})")
  ...
  SET(GLOBAL_COMPILER_FLAGS "${GLOBAL_COMPILER_FLAGS} -Wno-ignored-qualifiers")
  ...
  ADD_DEFINITIONS("-DGLM_PRECISION_MEDIUMP_INT")
  ADD_DEFINITIONS("-DGLM_PRECISION_MEDIUMP_FLOAT")
  ADD_DEFINITIONS("-DGLM_SWIZZLE")
ENDIF()

IF(MSVC)
  MESSAGE(STATUS "Applying Compiler Defaults for: MSVC (v. ${CMAKE_CXX_COMPILER_VERSION})")
