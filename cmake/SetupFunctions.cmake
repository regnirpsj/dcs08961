...
FUNCTION(LIBRARY_SETUP LIB_NAME)
  ...
  INSTALL(CODE
    "INSTALL(TARGETS ${PUBHDRS} ${PUBINLS} DESTINATION ${DCSC08961_HEADER_DIRECTORY} COMPONENT development)")
ENDFUNCTION()
...
FUNCTION(APPLICATION_SETUP APP_NAME)
  ...
  INSTALL(CODE
    "INSTALL(TARGETS ${APP_NAME} DESTINATION ${DCSC08961_RUNTIME_DIRECTORY} COMPONENT runtime)")
ENDFUNCTION()
