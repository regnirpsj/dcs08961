...
FUNCTION(LIBRARY_SETUP LIB_NAME)
  ...
  INSTALL(TARGETS ${LIB_NAME} ${INST_DST_TYPE} DESTINATION ${DCS08961_LIBRARY_DIRECTORY}
    COMPONENT lib)
...
FUNCTION(EXPORT_SETUP EXP_NAME)
  ...
  INSTALL(FILES ${EXP_FILE} DESTINATION ${DCS08961_HEADER_DIRECTORY}/${EXP_NAME} COMPONENT hdr)
ENDFUNCTION()
...
FUNCTION(TEST_SETUP TST_PREFIX)
  ...
  IF(DCS08961_BLD_UTEST)
    IF(DCS08961_RUN_CTEST)
...
FUNCTION(APPLICATION_SETUP APP_NAME)
  ...
  INSTALL(TARGETS ${APP_NAME} RUNTIME DESTINATION ${DCS08961_RUNTIME_DIRECTORY} COMPONENT app)
ENDFUNCTION()
