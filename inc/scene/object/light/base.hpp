...
/**************************************************************************************************/
/*                                                                                                */
/*  module     :  scene/object/light/base.hpp                                                     */
/*  project    :                                                                                  */
/*  description:                                                                                  */
/*                                                                                                */
/**************************************************************************************************/

#if !defined(UKACHULLDCS_08961_SCENE_OBJECT_LIGHT_BASE_HPP)

#define UKACHULLDCS_08961_SCENE_OBJECT_LIGHT_BASE_HPP
...
namespace scene {
  ...
  namespace object {
    ...
    namespace light {
      ...
      struct DCS08961_SCENE_EXPORT base : public object::base {
...
#endif // #if !defined(UKACHULLDCS_08961_SCENE_OBJECT_LIGHT_BASE_HPP)
